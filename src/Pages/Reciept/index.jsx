    ...
    <>
      <div className=' sm:px-5 xl:px-10 py-5 h-full'>
        <div className=' py-5 px-5'>
          <h1 className='text-[#0d0d48] text-2xl font-bold'>Receipt Search</h1>
            ...
            >
              ...
              <tbody className="bg-white items-center  overflow-x-scroll xl:overflow-x-hidden 2xl:overflow-x-hidden">
                <tr className=" border-b">
                  ...
                  <td className="px-6 py-5">
                    <h1 className='bg-green-300 text-green-900 font-bold py-[2px] rounded-sm'>
                      5000
                    </h1>
                  </td>
                  <td className="px-6 py-5">
                    <h1 className='bg-blue-200 text-blue-900 font-bold py-[2px] rounded-sm'>
                      5000
                    </h1>
                  </td>
                  <td className="px-6 py-5">
