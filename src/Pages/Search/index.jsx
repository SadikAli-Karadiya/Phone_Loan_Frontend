        ...
        <div>
            <div className=' px-10 py-5 h-full'>
                <div className=' py-5 px-5'>
                    <h1 className='text-[#0d0d48] text-2xl font-bold'>Search Past/Current Customers</h1>
            ...
            shadow-xl cursor-pointer text-white text-2xl '>
              ...
              PhoneInfo.map((data, index) => {
                ...
                return ( */}
                        <ul
                            // key={index}
                            className="flex items-center space-x-2 justify-between font-normal md:px-2 py-6 rounded-lg cursor-pointer shadow-sm "
                        >
