            ...
            <div className="px-12 py-20">
                ...
                <div className="overflow-x-auto">
                    <table className="w-full whitespace-nowrap">
                        <thead>
                            <tr className="bg-gray-200 jus h-16 w-full text-sm leading-none font-bold text-[#0d0d48]">
                ...
                admins?.data.map((m, key) => {
                  ...
                  return ( */}
                            <tr className="h-20 text-sm leading-none bg-white text-gray-800 border-b border-gray-100">
                                ...
                                <td className="px-10 lg:px-6 xl:px-0">
                                    <span className=""> 0000 </span>
                                </td>

                                <td className="">
                                    <span className="">
                                        <button
                                            onClick={(e) => handleMakeAdmin()}
